    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4 col-md-3">
                <h3>产品中心</h3>
                <div class="list-group" style="background-color:whitesmoke">
                    <a href="category.html" class="">PCLE板卡产品</a>
                    <a href="category.html" class="">FMC板卡产品</a>
                    <a href="category.html" class="">以太网数据采集</a>
                    <a href="category.html" class="">VPX产品</a>
                    <a href="category.html" class="">射频产品</a>
                    <a href="category.html" class="">PCLE数据采集</a>
                    <a href="category.html" class="">高速图像类产品</a>
                    <a href="category.html" class="">测控软件开发</a>
                    <a href="category.html" class="">测控软件开发</a>
                </div>
            </div>
            <div class="col-sm-8 col-md-9">
				<c:forEach items="${newItemsList}" var="newitem">
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                        <img src='${picPath}${newitem.newitemid}.jpg' alt="">
                        <div class="caption">
                            <h4><a href="${pageContext.request.contextPath }/controller/user/findnewitemnbyname.do?newitemname=${newitem.newitemname}">${newitem.newitemname} </a></h4>
